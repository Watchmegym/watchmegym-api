...
const { CreateBioimpedanceSchema, UpdateBioimpedanceSchema, MachineUploadSchema } = require('../schemas/bioimpedance.schema');

// Rotas de bioimpedâncias
router.post('/upload', validate(MachineUploadSchema), BioimpedanceController.upload);
